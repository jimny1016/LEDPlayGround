...
namespace LEDPlayground
{
    public class LianLiUniHubSLV2Controller
    {
        ...
        public LianLiUniHubSLV2Controller(uint color, byte channel)
        {
            ...
            if (deviceInfo != null)
            {
                ...
                try
                {
                    ...
                    SendStartAction(channel, lEDData.FanIndex + 1);
                    SendColorData(channel, (lEDData.FanIndex + 1) * ONE_FAN_LED_COUNT, lEDData.LEDData);
                    SendCommitAction(channel, UNIHUB_SLV2_LED_MODE_STATIC_COLOR, UNIHUB_SLV2_LED_SPEED_000, UNIHUB_SLV2_LED_DIRECTION_LTR, UNIHUB_SLV2_LED_BRIGHTNESS_100);
