...
{
    class WindowsScreenAPITest
    {
        public WindowsScreenAPITest()
        {
        ...
        public void CloseInactiveAndResetInactive()
        {
        ...
        public void ResetPrimaryDevice()
        {
            uint iDeviceCntr = 0;
            DISPLAY_DEVICE dd = new DISPLAY_DEVICE();
            dd.cb = Marshal.SizeOf(dd);
